...
public class CabeActivity extends AppCompatActivity {
    ...
    public void calculateTotalPrice() {
        ...
        double harga250gr = 5000;
        double harga500gr = 8000;
        double harga1kg = 10000;
    ...
    public void addToCart(View view) {
        ...
        db.collection("products")
                ...
                .addOnSuccessListener(aVoid -> {
                    ...
                    Intent cartIntent = new Intent(CabeActivity.this, MainActivity.class);
