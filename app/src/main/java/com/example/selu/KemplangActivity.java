...
public class KemplangActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kemplang);
    ...
    public void calculateTotalPrice() {
        ...
        double harga250gr = 20000;
        double harga500gr = 40000;
        double harga1kg = 80000;
    ...
    public void addToCart(View view) {
        ...
        String productNama = "Kemplang";
        double productHarga = totalHarga;
        int productJumlah = count;


        Product product = new Product(productNama, productHarga, productJumlah, username);
        ...
        db.collection("products")
                ...
                .addOnSuccessListener(aVoid -> {
                    ...
                    Intent cartIntent = new Intent(KemplangActivity.this, MainActivity.class);
