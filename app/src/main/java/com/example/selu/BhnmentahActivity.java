...
public class BhnmentahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bhnmentah);
    ...
    public void calculateTotalPrice() {
        ...
        double harga500gr = 35000;
        double harga1kg   = 50000;
    ...
    public void addToCart(View view) {
        ...
        String productName = "Bahan Mentah";
        ...
        db.collection("products")
                ...
                .addOnSuccessListener(aVoid -> {
                    ...
                    Intent cartIntent = new Intent(BhnmentahActivity.this, MainActivity.class);
