...
public class MentahActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mentah);
    ...
    public void addToCart(View view) {
        ...
        db.collection("products")
                ...
                .addOnSuccessListener(aVoid -> {
                    ...
                    Intent cartIntent = new Intent(MentahActivity.this, MainActivity.class);
